...
const ANIMEPAHE = {
  ...
  apiHosts: [
      'https://anitaku.api.animight.com/anime/animepahe',
      'https://consumet-api.herokuapp.com/anime/animepahe',
  ...
  async _api(endpoint) {
    ...
    throw new Error("All AnimePahe APIs blocked by Cloudflare.");
  },
